...
# # SPCS
org1_perf1 = org_1.performances.create(performance_year: 2016)
org1_perf2 = org_1.performances.create(performance_year: 2017)
org1_perf3 = org_1.performances.create(performance_year: 2018)
org1_perf4 = org_1.performances.create(performance_year: 2019)
org1_perf5 = org_1.performances.create(performance_year: 2020)

org1_perf1.performance_compositions.create(composition_id: comp_6.id)
org1_perf2.performance_compositions.create(composition_id: comp_8.id)
org1_perf2.performance_compositions.create(composition_id: comp_7.id)
org1_perf3.performance_compositions.create(composition_id: comp_5.id)
org1_perf4.performance_compositions.create(composition_id: comp_1.id)
org1_perf5.performance_compositions.create(composition_id: comp_9.id)


# # MSO
org2_perf1 = org_2.performances.create(performance_year: 2016)
org2_perf2 = org_2.performances.create(performance_year: 2017)
org2_perf3 = org_2.performances.create(performance_year: 2018)
org2_perf4 = org_2.performances.create(performance_year: 2019)

org2_perf1.performance_compositions.create(composition_id: comp_1.id)
org2_perf2.performance_compositions.create(composition_id: comp_10.id)
org2_perf3.performance_compositions.create(composition_id: comp_9.id)
org2_perf4.performance_compositions.create(composition_id: comp_2.id)